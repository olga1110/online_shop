...
urlpatterns = [
    ...
    path('Catalog/Tables/<slug:title>/', views.product_detail, name='detail'),
    path('Catalog/Sofas/<slug:title>/', views.product_detail, name='detail'),
    path('Catalog/Suite/<slug:title>/', views.product_detail, name='detail'),
