...
urlpatterns = [
    ...
    path('catalog/Tables/<slug:slug>/', ProductDetail.as_view(), name='tables'),
    path('catalog/Sofas/<slug:slug>/',ProductDetail.as_view(), name='sofas'),
    path('catalog/Sets/<slug:slug>/', ProductDetail.as_view(), name='suite'),
